...
name: skill-creator
description: >
  Guide for creating effective skills for Apollo Solutions and Field teams. Use this skill when:
  (1) users want to create a new skill for this repository,
...
- [Apollo Skills](references/apollo-skills.md) - Patterns and examples for Apollo Solutions skills
...
- ALWAYS set `metadata.author` to `apollosolutions`
