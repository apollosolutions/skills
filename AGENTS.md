...
This repository contains AI agent skills maintained by the Apollo Solutions and Field teams, following the [Agent Skills](https://agentskills.io/) format. Skills are documentation bundles that AI coding assistants can use to provide context-aware help with Apollo technologies. These skills may be experimental or not fully supported.
...
- `metadata`: author (apollosolutions) and version
